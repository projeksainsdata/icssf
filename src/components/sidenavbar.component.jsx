...
const SideNav = () => {
    ...
    return (
        access_token === null ? <Navigate to="/signin" /> :
            <>
                <section className="relative flex gap-10 py-0 m-0 max-md:flex-col mb-10">
                    <div className="sticky top-[80px] z-30">
                        <div className="md:hidden bg-black-bg py-1 border-b border-grey flex flex-nowrap overflow-x-auto ">
                        ...
                        <div className={"min-w-[200px] h-[calc(100vh-80px-60px)] md:h-cover md:sticky top-24 overflow-y-auto p-6 md:pr-0 md:border-green-orange md:border-r absolute max-md:top-[64px] bg-black-bg max-md:w-[calc(100%+80px)] max-md:px-16 max-md:-ml-7 duration-500 " + (!showSideNav ? "max-md:opacity-0 max-md:pointer-events-none" : "opacity-100 pointer-events-auto")}>
                            <h1 className="text-xl text-gren-orange mb-3">Dashboard</h1>
